defmodule StradaleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StradaleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StradaleWeb.Gettext, "errors", msg, opts)
    end
  end
